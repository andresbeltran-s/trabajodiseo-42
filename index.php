	...
	<body>
		...
		<main>
			...
			<section id="nosotros" class="seccion">
				<div class="container">
					Duis aute irure dolor in reprehenderit in voluptate velit essecillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat nonproident, sunt in culpa qui officia deserunt mollit anim id est laborum.
				</div>
			</section>
			...
			<section id="contactenos" class="seccion">
				<iframe width="643" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=643&amp;height=400&amp;hl=en&amp;q=%20quito+(Ecuador)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
				<div class="container-fluid">
					<div class="row">
									...
									if($_SERVER["REQUEST_METHOD"]== "POST")
									{
										...
										if(isset($nombre))
										{
											if(isset($email))
											{
												if(isset($mensaje))
												{
													$para = "andresbeltran0959Qgmail.com";
													$asunto = "esto es una prueba";
													$cuerpo = $nombre. "\n".$email."\n".$mensaje;
													$adicional = "Form: hugoperez0959@gmail.com";
			...
			<div class="container">
				<div class="row">
					...
					<div class="columna columna-25 columna-mobile-100">
						...
						<ul>
							<li>andresbeltran0959@gmail.com</li>
							<li>0959625462</li>
							<li>Av. las Americas-Isabela Catolica<br>cuenca Ecuador</li>
						</ul>
					</div>
					<div class="columna columna-25 columna-mobile-100">
						<h3>
